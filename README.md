...
------------
    ...
    │
    ├── setup.py           <- makes project pip installable (pip install -e .) so applieddatascience can be imported
    ├── applieddatascience                <- Source code for use in this project.
    │   ├── __init__.py    <- Makes applieddatascience a Python module
    │   │
...
One should be up and running as follows:
    ...
    source activate applied_datascience
    make requirements
